            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
               <ul class="navbar-nav ">
                  ...
                  <li class="nav-item dropdown active">
                     ...
                     <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="nav-link" href="product1.html">Pâtisserie</a>
                        <a class="nav-link " href="product2.html">Salés</a>
                        <a class="nav-link " href="product3.html">Jus</a>
                        <a class="nav-link " href="product4.html">Gàteaux</a>
                     </div>
                  </li>
                  <li class="nav-item">
...
$sql='SELECT * FROM produitensolde UNION SELECT reference,nom,prix,description,photo,type,5 from produit  ';
 ...
 $products = $DB->query($sql);
  ?>
    <!--//SELECTEEEEEETOIILEEEEEEEEE wfet-->
    <div class="deal-leftmk left-side">
                     <h3 class="agileits-sear-head">Special Deals</h3>
                     <div class="row special-sec1">
                        <div class="col-xs-4 img-deals">
                           <img src="img/p101.jpg" alt="" class="img-fluid">
                        </div>
                        <div class="col-xs-8 img-deal1">
                           <h3>Pack Saint Valentin</h3>
                           <a href="single.html">DT 40.000</a>
                        </div>
         ...
         <div class="row">
            ...
            <div class="col-lg-6 col-md-6 address-w3l-right text-center">
               <div class="address-gried ">
                  ...
                  <p>5 rue Imam Abou Hanifa. <br>Menzah 7
Tunis, Tunisia
                  <p>
               </div>
               <div class="address-gried mt-3">
                  <span class="fas fa-phone-volume"></span>
                  <p> 71 230 643<br>71 230 643</p>
               </div>
               <div class=" address-gried mt-3">
